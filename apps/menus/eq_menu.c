...
#ifdef MORE_EQ_BANDS_24
            &gain_item_9, &gain_item_10, &gain_item_11, &gain_item_12,
            &gain_item_13, &gain_item_14, &gain_item_15, &gain_item_16,
            &gain_item_17, &gain_item_18, &gain_item_19, &gain_item_20,
            &gain_item_21, &gain_item_22, &gain_item_23);
#else
	    &gain_item_9);
#endif
...
MAKE_MENU(advanced_eq_menu_, ID2P(LANG_EQUALIZER_ADVANCED), NULL, Icon_EQ,
            ...
            &band_10_menu, &band_11_menu, &band_12_menu, &band_13_menu, &band_14_menu,
            &band_15_menu, &band_16_menu, &band_17_menu, &band_18_menu, &band_19_menu,
            &band_20_menu, &band_21_menu, &band_22_menu, &band_23_menu);
#else
            &band_5_menu, &band_6_menu, &band_7_menu, &band_8_menu, &band_9_menu);
#endif

...
/** End of old RTC config block **/
    ...
    INT_SETTING_NOWRAP(F_SOUNDSETTING, crossfeed_direct_gain,
                       ...
                       "crossfeed direct gain", UNIT_DB, -60, 0, 1,
    ...
    INT_SETTING_NOWRAP(F_SOUNDSETTING, crossfeed_cross_gain,
                       ...
                       "crossfeed cross gain", UNIT_DB, -120, -30, 1,
    ...
    INT_SETTING_NOWRAP(F_SOUNDSETTING, crossfeed_hf_attenuation,
                       ...
                       "crossfeed hf attenuation", UNIT_DB, -240, -60, 1,
                       db_format, get_dec_talkid, crossfeed_cross_set),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, crossfeed_hf_cutoff,
                       LANG_CROSSFEED_HF_CUTOFF, 700,
                       "crossfeed hf cutoff", UNIT_HERTZ, 500, 2000, 1,
    ...
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band2_cutoff, LANG_EQUALIZER_BAND_CENTER,
                       400, "eq band 2 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                       EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    ...
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band4_cutoff, LANG_EQUALIZER_BAND_CUTOFF,
                       800, "eq band 4 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                       EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band5_cutoff, LANG_EQUALIZER_BAND_CENTER,
                      1000, "eq band 5 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                      EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band6_cutoff, LANG_EQUALIZER_BAND_CENTER,
                      2000, "eq band 6 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                      EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band7_cutoff, LANG_EQUALIZER_BAND_CENTER,
                      4000, "eq band 7 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                     EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band8_cutoff, LANG_EQUALIZER_BAND_CENTER,
                      7000, "eq band 8 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                      EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band9_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    10000, "eq band 9 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band10_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    14000, "eq band 10 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band11_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    18000, "eq band 11 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band12_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    18000, "eq band 12 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band13_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    18000, "eq band 13 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band14_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    18000, "eq band 14 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band15_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    18000, "eq band 15 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band16_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    18000, "eq band 16 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
   INT_SETTING_NOWRAP(F_EQSETTING, eq_band17_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    18000, "eq band 17 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band18_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    18000, "eq band 18 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band19_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    18000, "eq band 19 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band20_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    18000, "eq band 20 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band21_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    18000, "eq band 21 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band22_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    18000, "eq band 22 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band23_cutoff, LANG_EQUALIZER_BAND_CENTER,
                    18000, "eq band 23 cutoff", UNIT_HERTZ, EQ_CUTOFF_MIN,
                    EQ_CUTOFF_MAX, EQ_CUTOFF_STEP, NULL, NULL, NULL),
    /* 0..64 (or 0.0 to 6.4) */
    ...
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band3_q, LANG_EQUALIZER_BAND_Q, 10,
                       ...
                       eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band4_q, LANG_EQUALIZER_BAND_Q, 10,
                       "eq band 4 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                       eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band5_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 5 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band6_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 6 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band7_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 7 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band8_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 8 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band9_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 9 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band10_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 10 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band11_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 11 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band12_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 12 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band13_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 13 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                     eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band14_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 14 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band15_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 15 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band16_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 16 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band17_q, LANG_EQUALIZER_BAND_Q, 10,
                    "eq band 17 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                    eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band18_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 18 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band19_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 19 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band20_q, LANG_EQUALIZER_BAND_Q, 10,
                    "eq band 20 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                    eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band21_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 21 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band22_q, LANG_EQUALIZER_BAND_Q, 10,
                      "eq band 22 q", UNIT_INT, EQ_Q_MIN, EQ_Q_MAX, EQ_Q_STEP,
                      eq_q_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band23_q, LANG_EQUALIZER_BAND_Q, 7,
    ...
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band4_gain, LANG_GAIN, 0,
                       ...
                       EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band5_gain, LANG_GAIN, 0,
                      "eq band 5 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band6_gain, LANG_GAIN, 0,
                      "eq band 6 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band7_gain, LANG_GAIN, 0,
                      "eq band 7 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band8_gain, LANG_GAIN, 0,
                      "eq band 8 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band9_gain, LANG_GAIN, 0,
                      "eq band 9 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band10_gain, LANG_GAIN, 0,
                      "eq band 10 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band11_gain, LANG_GAIN, 0,
                      "eq band 11 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band12_gain, LANG_GAIN, 0,
                      "eq band 12 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band13_gain, LANG_GAIN, 0,
                      "eq band 13 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band14_gain, LANG_GAIN, 0,
                      "eq band 14 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band15_gain, LANG_GAIN, 0,
                      "eq band 15 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band16_gain, LANG_GAIN, 0,
                      "eq band 16 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band17_gain, LANG_GAIN, 0,
                      "eq band 17 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band18_gain, LANG_GAIN, 0,
                      "eq band 18 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band19_gain, LANG_GAIN, 0,
                      "eq band 19 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band20_gain, LANG_GAIN, 0,
                      "eq band 20 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band21_gain, LANG_GAIN, 0,
                      "eq band 21 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band22_gain, LANG_GAIN, 0,
                      "eq band 22 gain", UNIT_DB, EQ_GAIN_MIN, EQ_GAIN_MAX,
                      EQ_GAIN_STEP, db_format, get_dec_talkid, NULL),
    INT_SETTING_NOWRAP(F_EQSETTING, eq_band23_gain, LANG_GAIN, 0,

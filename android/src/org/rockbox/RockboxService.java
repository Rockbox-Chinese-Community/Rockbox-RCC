    ...
    private void startService()
    {
        ...
        Thread rb = new Thread(new Runnable()
        {
            public void run()
            {
                ...
                String androidSdDirPath = "/sdcard";
                ...
                File androidsdcard = new File(androidSdDirPath);
                ...
                if (!rockboxConfig.exists()) {
                    ...
                    try {
                        ...
                        strm.write("default codepage: gb2312" + "\n");
                        strm.write("list padding: 20" + "\n");
                        strm.write("font: /.rockbox/fonts/26-wqy-microhei.fnt" + "\n");
                        strm.write("wps: /.rockbox/wps/m9musicv2.wps" + "\n");
                        strm.write("sbs: /.rockbox/wps/m9musicv2.sbs" + "\n");
                        strm.write("lang: /.rockbox/langs/chinese-simp.lng" + "\n");
                        strm.write("backdrop: /.rockbox/backdrops/m9musicv2bg.bmp" + "\n");
                        strm.write("iconset: /.rockbox/icons/RaaA.bmp" + "\n");
                        strm.write("viewers iconset: /.rockbox/icons/RaaA_Viewers.bmp" + "\n");
                        strm.write("scrollbar: right" + "\n");
                        strm.write("selector type: pointer" + "\n");
                        strm.write("foreground color: ced3ce" + "\n");
                        strm.write("show files: all" + "\n");
                        strm.write("show path in browser: full path" + "\n");
                        strm.close();
                    } catch(Exception e) {
